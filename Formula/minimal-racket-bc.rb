class MinimalRacketBc < Formula
  desc "Modern programming language in the Lisp/Scheme family (BC version)"
  ...
  def caveats
    <<~EOS
      ...
      This version is the BC (ByteCode/Before Chez) version of Racket.
      If you do not know what that means, you should probably install the regular version:
